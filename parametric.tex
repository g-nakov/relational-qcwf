...
\newpage
%$|\Pi^R \pi S T|(\gamma) = \{f : S \to T\ | \exists a_f .\; a \vDash_{S(\gamma)} x \implies a_f  \cdot !_\pi a \vDash_{T(\gamma, x)} f(x) \}$
%
%$a \vDash_{\Pi^R \pi S T(\gamma)}  f = \exists a_f .\; a \vDash_{S(\gamma)} x \implies a_f  \cdot !_\pi a \vDash_{T(\gamma, x)} f(x)$
