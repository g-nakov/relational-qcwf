...
$\begin{aligned}
  ...
  U\R &\define \{(A, B, R, R\src, R\tgt) : R \in \mathcal{U}, R\src: R \to A\O, R\tgt : R \to A\O, A,B \text{ are small r.g.}   \}
\end{aligned}$.\\
...
\begin{itemize}
  ...
  \item $\begin{aligned}
  U\R(\gamma\O) \define \{(S,T, R, & R\src, R\tgt) \quad|\quad R \in \mathcal{U} \\
